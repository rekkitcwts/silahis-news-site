<?php
    ...
    if (!empty($where_clause)) {
      $search_query .= " WHERE ($where_clause) AND (staff.staff_id NOT IN (SELECT staff_position.staff_id FROM staff_position))";
    }
    else
    {
    	$search_query .= " WHERE staff.staff_id NOT IN (SELECT staff_position.staff_id FROM staff_position)";
    }
