					...
					<div class="row">
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                ...
                                <a href="#" class="small-box-footer" title="These are the unedited articles submitted by writers under your control">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-green">
                                <div class="inner">
                                    ...
                                    <p>
                                        Articles you disapprove
                                    </p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-stats-bars"></i>
                                </div>
                                <a href="#" class="small-box-footer" title="These are the articles by your writers that are disapproved due to some reasons (e.g. needs clarification and editing)">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                <div class="inner">
                                    ...
                                    <p>
                                        Articles you approve
                                    </p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-person-add"></i>
                                </div>
                                <a href="#" class="small-box-footer" title="These are the articles by your writers live on the site. They were approved by you or another editor.">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                ...
                                <a href="#" class="small-box-footer" title="These are the articles by your writers that are used to be on the site, but was taken down due to legal reasons and oligarchy.">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
